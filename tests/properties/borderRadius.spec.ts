...
describe('IDisplayElement.borderRadius property', () => {
    ...
    describe('borderRadius property', () => {
        ...
        it('given borderRadius is 0, when borderRadius = 0, style.borderRadius should be 0px', () => {
            const displayElement: DisplayElement = new DisplayElement();
            displayElement.borderRadius = 0;
            assert.strictEqual(displayElement.style.borderRadius, '0px');
        });
        it('given borderRadius is 10, when borderRadius = NaN, style.borderRadius should be 0px', () => {
            const displayElement: DisplayElement = new DisplayElement();
            displayElement.borderRadius = 10;
            displayElement.borderRadius = NaN;
            assert.strictEqual(displayElement.style.borderRadius, '0px');
        });
        it('given borderRadius is 0, when borderRadius = ' + minusRandom + ', style.borderRadius should be 0', () => {
            const displayElement: DisplayElement = new DisplayElement();
            displayElement.borderRadius = minusRandom;
            assert.strictEqual(displayElement.style.borderRadius, '0px');
        });
